...
describe('SignupPage Component', () => {
    ...
    // test('Already registered user tried to signup-failing testcase-email case', async () => {
...
// test('Already registered user tried to signup-failing testcase-mobile number', async () => {
